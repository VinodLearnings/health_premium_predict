...
model_xgb = joblib_load(ARTIFACTS_DIR / "model_xgboost.joblib")
model_scaler = joblib_load(ARTIFACTS_DIR / "scaler_with_cols.joblib")
...
def predict(input_dict):
    df = pre_process(input_dict)
    amount_predict  = model_xgb.predict(df)
    return amount_predict[0].round(2)